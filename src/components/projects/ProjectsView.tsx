...
import { MOCK_PROJECTS, GoogleDriveIcon, MailIcon, FileTextIcon, ZapIcon, AirtableIcon, SparklesIcon, Trash2Icon, PlusCircleIcon, ClipboardListIcon, ClockIcon, AlertTriangleIcon, CheckCircleIcon, FolderIcon } from '../../constants';
